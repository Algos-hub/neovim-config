...
var require_node = __commonJS({
  "node_modules/php-parser/src/ast/node.js"(exports, module2) {
    "use strict";
    var Node7 = function Node8(kind, docs, location) {
      this.kind = kind;
      if (docs) {
    ...
    Node7.prototype.setTrailingComments = function(docs) {
      this.trailingComments = docs;
    };
    Node7.prototype.destroy = function(node) {
      if (!node) {
        throw new Error(
    ...
    Node7.prototype.includeToken = function(parser) {
      if (this.loc) {
        if (this.loc.end) {
    ...
    Node7.extends = function(type, constructor) {
...
var require_expression = __commonJS({
  "node_modules/php-parser/src/ast/expression.js"(exports, module2) {
    "use strict";
    var Node7 = require_node();
    var KIND = "expression";
    module2.exports = Node7.extends(KIND, function Expression(kind, docs, location) {
      Node7.apply(this, [kind || KIND, docs, location]);
    });
  }
});
...
var require_attribute2 = __commonJS({
  "node_modules/php-parser/src/ast/attribute.js"(exports, module2) {
    ...
    var Node7 = require_node();
    var KIND = "attribute";
    module2.exports = Node7.extends(
      KIND,
      function Attribute(name, args, docs, location) {
        Node7.apply(this, [KIND, docs, location]);
        this.name = name;
        this.args = args;
      }
    );
...
var require_attrgroup = __commonJS({
  "node_modules/php-parser/src/ast/attrgroup.js"(exports, module2) {
    ...
    var Node7 = require_node();
    var KIND = "attrgroup";
    module2.exports = Node7.extends(KIND, function AttrGroup(attrs, docs, location) {
      Node7.apply(this, [KIND, docs, location]);
      this.attrs = attrs || [];
    });
  }
...
var require_statement2 = __commonJS({
  "node_modules/php-parser/src/ast/statement.js"(exports, module2) {
    ...
    var Node7 = require_node();
    var KIND = "statement";
    module2.exports = Node7.extends(KIND, function Statement(kind, docs, location) {
      Node7.apply(this, [kind || KIND, docs, location]);
    });
  }
});
...
var require_call = __commonJS({
  "node_modules/php-parser/src/ast/call.js"(exports, module2) {
    ...
    module2.exports = Expression.extends(
      KIND,
      function Call2(what, args, docs, location) {
        Expression.apply(this, [KIND, docs, location]);
        this.what = what;
        this.arguments = args;
      }
...
var require_class2 = __commonJS({
  "node_modules/php-parser/src/ast/class.js"(exports, module2) {
    ...
    module2.exports = Declaration.extends(
      KIND,
      function Class5(name, ext, impl, body, flags, docs, location) {
...
var require_comment2 = __commonJS({
  "node_modules/php-parser/src/ast/comment.js"(exports, module2) {
    ...
    module2.exports = Node7.extends(
      "comment",
      function Comment3(kind, value, docs, location) {
        Node7.apply(this, [kind, docs, location]);
        this.value = value;
      }
    );
...
var require_commentblock = __commonJS({
  "node_modules/php-parser/src/ast/commentblock.js"(exports, module2) {
    ...
    module2.exports = Comment3.extends(
      KIND,
      function CommentBlock3(value, docs, location) {
        Comment3.apply(this, [KIND, value, docs, location]);
      }
    );
  }
});
...
var require_identifier = __commonJS({
  "node_modules/php-parser/src/ast/identifier.js"(exports, module2) {
    ...
    var Node7 = require_node();
    var KIND = "identifier";
    var Identifier4 = Node7.extends(
      KIND,
      function Identifier5(name, docs, location) {
        Node7.apply(this, [KIND, docs, location]);
        this.name = name;
      }
    );
...
var require_reference = __commonJS({
  "node_modules/php-parser/src/ast/reference.js"(exports, module2) {
    ...
    var Node7 = require_node();
    var KIND = "reference";
    var Reference = Node7.extends(KIND, function Reference2(kind, docs, location) {
      Node7.apply(this, [kind || KIND, docs, location]);
    });
...
var require_name = __commonJS({
  "node_modules/php-parser/src/ast/name.js"(exports, module2) {
    ...
    var KIND = "name";
    var Name3 = Reference.extends(
      KIND,
      function Name4(name, resolution, docs, location) {
...
var require_namespace2 = __commonJS({
  "node_modules/php-parser/src/ast/namespace.js"(exports, module2) {
    ...
    module2.exports = Block.extends(
      KIND,
      function Namespace6(name, children, withBrackets, docs, location) {
...
var require_new = __commonJS({
  "node_modules/php-parser/src/ast/new.js"(exports, module2) {
    ...
    module2.exports = Expression.extends(
      KIND,
      function New2(what, args, docs, location) {
        Expression.apply(this, [KIND, docs, location]);
        this.what = what;
        this.arguments = args;
      }
...
var require_noop = __commonJS({
  "node_modules/php-parser/src/ast/noop.js"(exports, module2) {
    ...
    var Node7 = require_node();
    var KIND = "noop";
    module2.exports = Node7.extends(KIND, function Noop(docs, location) {
      Node7.apply(this, [KIND, docs, location]);
    });
  }
});
...
var require_nullkeyword = __commonJS({
  "node_modules/php-parser/src/ast/nullkeyword.js"(exports, module2) {
    ...
    module2.exports = Node7.extends(KIND, function NullKeyword(raw, docs, location) {
      Node7.apply(this, [KIND, docs, location]);
      this.raw = raw;
    });
  }
...
var require_property2 = __commonJS({
  "node_modules/php-parser/src/ast/property.js"(exports, module2) {
    ...
    module2.exports = Statement.extends(
      KIND,
      function Property3(name, value, readonly, nullable, type, attrGroups, docs, location) {
        Statement.apply(this, [KIND, docs, location]);
        this.name = name;
        this.value = value;
        this.readonly = readonly;
...
var require_propertystatement = __commonJS({
  "node_modules/php-parser/src/ast/propertystatement.js"(exports, module2) {
    ...
    var IS_PROTECTED = "protected";
    var IS_PRIVATE = "private";
    var PropertyStatement3 = Statement.extends(
      KIND,
      function PropertyStatement4(kind, properties, flags, docs, location) {
        Statement.apply(this, [KIND, docs, location]);
...
var require_typereference = __commonJS({
  "node_modules/php-parser/src/ast/typereference.js"(exports, module2) {
    ...
    var TypeReference3 = Reference.extends(
      KIND,
      function TypeReference4(name, raw, docs, location) {
        Reference.apply(this, [KIND, docs, location]);
        this.name = name;
        this.raw = raw;
      }
...
var require_usegroup = __commonJS({
  "node_modules/php-parser/src/ast/usegroup.js"(exports, module2) {
    ...
    module2.exports = Statement.extends(
      KIND,
      function UseGroup2(name, type, items, docs, location) {
        Statement.apply(this, [KIND, docs, location]);
        this.name = name;
        this.type = type;
        this.items = items;
...
var require_useitem = __commonJS({
  "node_modules/php-parser/src/ast/useitem.js"(exports, module2) {
    ...
    var Statement = require_statement2();
    var KIND = "useitem";
    var UseItem2 = Statement.extends(
      KIND,
      function UseItem3(name, alias, type, docs, location) {
        Statement.apply(this, [KIND, docs, location]);
        this.name = name;
        this.alias = alias;
        this.type = type;
      ...
      const result = function() {
        ...
        if (self.withPositions || self.withSource) {
          ...
          location = new Location(
            src,
            start,
            new Position14(parser.prev[0], parser.prev[1], parser.prev[2])
          );
          args.push(location);
        }
        if (!kind) {
...
var require_src = __commonJS({
  "node_modules/php-parser/src/index.js"(exports, module2) {
    ...
    Engine8.create = function(options) {
      return new Engine8(options);
    };
    Engine8.parseEval = function(buffer, options) {
      const self = new Engine8(options);
      return self.parseEval(buffer);
    };
    Engine8.prototype.parseEval = function(buffer) {
      this.lexer.mode_eval = true;
      this.lexer.all_tokens = false;
      buffer = getStringBuffer(buffer);
      return this.parser.parse(buffer, "eval");
    };
    Engine8.parseCode = function(buffer, filename, options) {
    ...
    Engine8.prototype.parseCode = function(buffer, filename) {
      this.lexer.mode_eval = false;
      this.lexer.all_tokens = false;
      buffer = getStringBuffer(buffer);
      return this.parser.parse(buffer, filename);
    };
    Engine8.tokenGetAll = function(buffer, options) {
      const self = new Engine8(options);
      return self.tokenGetAll(buffer);
    };
    Engine8.prototype.tokenGetAll = function(buffer) {
      this.lexer.mode_eval = false;
    ...
    module2.exports.Engine = Engine8;
    module2.exports.default = Engine8;
  }
});
...
function register(context) {
  ...
  context.subscriptions.push(
    import_coc.languages.registerCodeActionProvider(documentSelector, new ChangeVisibilityCodeActionProvider(), "intelephense")
  );
  context.subscriptions.push(
    import_coc.commands.registerCommand("intelephense.runChangeVisibility", runChangeVisibilityCommand(), null, true)
  );
}
...
function register2(context) {
  const documentSelector = [{ language: "php", scheme: "file" }];
  context.subscriptions.push(
    import_coc2.languages.registerCodeActionProvider(documentSelector, new GetterSetterCodeActionProvider(), "intelephense")
  );
}
...
`);
      ...
      if (item.propertyType && Array.isArray(item.propertyType)) {
        const property = item.propertyType.join("|");
        lines.push(
          `${indentSpace}public function ${item.methodName}(${item.propertyNullable ? "?" : ""}${property} $${item.propertyName})
`
        );
      } else if (item.propertyType && typeof item.propertyType === "string") {
        lines.push(
          `${indentSpace}public function ${item.methodName}(${item.propertyNullable ? "?" : ""}${item.propertyType} $${item.propertyName})
`
        );
      } else {
...
var IgnoreCommentCodeActionProvider = class {
  async provideCodeActions(document, range, context) {
    ...
    if (this.lineRange(range) && context.diagnostics.length > 0) {
      ...
      if (!thisLineContent.startsWith("/**") && !thisLineContent.startsWith("*") && existsIntelephenseDiagnostics) {
        const edit = import_coc3.TextEdit.replace(
          range,
...
var OpenPHPNetCodeActionProvider = class {
  ...
  async provideCodeActions(document, range, context) {
    ...
    if (
      // Line
      this.lineRange(range) || // Cursol & Selected at current line
...
// src/actions/removeUnusedImports.ts
function register5(context) {
  const documentSelector = [{ language: "php", scheme: "file" }];
  context.subscriptions.push(
    import_coc5.languages.registerCodeActionProvider(documentSelector, new RemoveUnusedImportsCodeActionProvider(), "intelephense")
  );
}
var RemoveUnusedImportsCodeActionProvider = class {
  ...
  generateEdit(item, document) {
    ...
    if (item.name === null && item.items.length === 1) {
      ...
      edit = import_coc5.TextEdit.del(
        import_coc5.Range.create(
          import_coc5.Position.create(prevStartLine, prevStartEndColumn),
          import_coc5.Position.create(item.rangeEndLine, item.rangeEndCharacter)
        )
      );
      ...
      edit = import_coc5.TextEdit.del(
        import_coc5.Range.create(import_coc5.Position.create(prevStartLine, prevStartEndColumn), import_coc5.Position.create(endLine, endColmun))
      );
      ...
      const endLine = item.locEndLine - 1;
      const endColmun = document.getline(endLine).length;
      edit = import_coc5.TextEdit.replace(
        import_coc5.Range.create(import_coc5.Position.create(startLine, startColumn), import_coc5.Position.create(endLine, endColmun)),
        newTexts.join("")
      );
...
function runCompleteConstructor() {
  return async () => {
    ...
    const constructorBodyContents = document.getText(
      import_coc6.Range.create(
        import_coc6.Position.create(constructor.body.loc.start.line - 1, constructor.body.loc.start.column),
        import_coc6.Position.create(constructor.body.loc.end.line - 1, constructor.body.loc.end.column)
      )
    );
...
${indentSpace}${indentSpace}$this->${cp3.propertyName} = $${cp3.propertyName};`);
    ...
    if (newPropContents) {
      edits.push(
        import_coc6.TextEdit.insert(
          import_coc6.Position.create(constructor.loc.start.line - 1, constructor.loc.start.column),
    ...
    if (newBodyContents) {
      edits.push(
        import_coc6.TextEdit.insert(
          import_coc6.Position.create(constructor.body.loc.start.line - 1, constructor.body.loc.start.column + 1),
...
var terminal;
function register7(context) {
  context.subscriptions.push(
    import_coc7.commands.registerCommand("intelephense.composer.runCommand", runComposerCommandCommand()),
    import_coc7.commands.registerCommand("intelephense.composer.runCommandPlus", runComposerCommandPlusCommand()),
  ...
  return async () => {
    ...
    const edits = [
      import_coc8.TextEdit.replace(
        import_coc8.Range.create(
          import_coc8.Position.create(classNameIdentifier.loc.start.line - 1, classNameIdentifier.loc.start.column),
          import_coc8.Position.create(classNameIdentifier.loc.end.line - 1, classNameIdentifier.loc.end.column)
        ),
        classNameByFilePath
      )
    ];
  ...
  return async () => {
    ...
    const edits = [
      import_coc9.TextEdit.replace(
        import_coc9.Range.create(
          import_coc9.Position.create(currentFileNsLoc.start.line - 1, currentFileNsLoc.start.column),
          import_coc9.Position.create(currentFileNsLoc.start.line - 1, declarationColumn)
        ),
...
function getAstByParseCode(code) {
  try {
    const parserEngine7 = getParserEngine();
    return parserEngine7.parseCode(code, "");
  } catch (e) {
    return void 0;
  }
}
function getParserEngine() {
  const parserEngine7 = new import_php_parser6.Engine({
    parser: {
      debug: false,
      extractDoc: true,
      php7: true,
...
function walk(callback, node, parent) {
...
function getPestTestItems(ast) {
  ...
  walk((node, parent) => {
    ...
    if (node.kind !== "name")
      return;
    const parentCallNode = parent;
    const nameNode = node;
    if (!parentCallNode.loc)
      return;
    if (!isPestTestName(nameNode.name))
      return;
    if (parentCallNode.arguments.length === 0)
      return;
    if (parentCallNode.arguments[0].kind !== "string")
      return;
    const stringNode = parentCallNode.arguments[0];
    items.push({
...
function isPestTestName(name) {
  return ["test", "it"].includes(name);
}
function getPestTestDescriptionAtEditorOffset(testItems, editorOffset) {
...
// src/common/phpunit.ts
function getPhpUnitTestItems(ast) {
  const items = [];
  walk((node, parent) => {
    if (!parent)
      return;
    ...
    if (node.kind !== "identifier")
      return;
    const parentMethodNode = parent;
    const identifierNode = node;
    if (!parentMethodNode.loc)
      return;
    if (!isPhpUnitTestName(identifierNode.name))
      return;
    items.push({
...
function isPhpUnitTestName(name) {
  return name.startsWith("test");
}
function getPhpUnitTestNameAtEditorOffset(testItems, editorOffset) {
  const testNames = [];
  for (const t of testItems) {
    if (t.startOffset <= editorOffset && t.endOffset >= editorOffset) {
...
function register10(context) {
  context.subscriptions.push(
    import_coc10.commands.registerCommand("intelephense.pest.projectTest", pestProjectTestCommand()),
    import_coc10.commands.registerCommand("intelephense.pest.fileTest", pestFileTestCommand()),
    import_coc10.commands.registerCommand("intelephense.pest.singleTest", pestSingleTestCommand())
  );
}
...
function getSailPath() {
  let cmdPath = "";
  const sailPath = import_coc10.workspace.getConfiguration("intelephense").get("sail.path");
  const vendorSailPath = import_path4.default.join(import_coc10.workspace.root, "vendor", "bin", "sail");
  if (sailPath && import_fs3.default.existsSync(sailPath)) {
    cmdPath = sailPath;
  } else if (import_fs3.default.existsSync(vendorSailPath)) {
    cmdPath = import_path4.default.join(import_coc10.workspace.root, "vendor", "bin", "sail");
  }
  return cmdPath;
}
async function runPest(filePath, testName) {
  ...
  const useSail = import_coc10.workspace.getConfiguration("intelephense").get("pest.useSail", false);
  if (pestBin) {
    if (terminal2) {
      if (terminal2.bufnr) {
    ...
    if (testName && filePath) {
      ...
      args.push(`'${testName}'`);
      if (useSail) {
        const relativeFilePath = filePath.replace(import_coc10.workspace.root, "").replace(/^\//, "");
        args.push(`${relativeFilePath}`);
        terminal2.sendText(`${sailBin} pest ${args.join(" ")}`);
      } else {
        args.push(`${filePath}`);
      ...
      if (args.length > 0) {
        ...
        if (useSail) {
          terminal2.sendText(`${sailBin} pest`);
        } else {
...
function pestSingleTestCommand() {
  return async () => {
    ...
    const ast = getAstByParseCode(document.getText());
    if (!ast)
      return;
    const testItems = getPestTestItems(ast);
    const pestTestName = getPestTestDescriptionAtEditorOffset(testItems, editorOffset);
    let testName = "";
    if (pestTestName) {
      testName = pestTestName;
    } else {
      const phpUnitStyleTestItems = getPhpUnitTestItems(ast);
      const phpUnitTestName = getPhpUnitTestNameAtEditorOffset(phpUnitStyleTestItems, editorOffset);
      if (phpUnitTestName)
        testName = phpUnitTestName;
    }
    if (testName) {
...
var terminal3;
function register11(context) {
  context.subscriptions.push(
    import_coc11.commands.registerCommand("intelephense.phpunit.projectTest", phpunitProjectTestCommand()),
    import_coc11.commands.registerCommand("intelephense.phpunit.fileTest", phpunitFileTestCommand()),
    import_coc11.commands.registerCommand("intelephense.phpunit.singleTest", phpunitSingleTestCommand())
  );
}
...
function getSailPath2() {
  let cmdPath = "";
  const sailPath = import_coc11.workspace.getConfiguration("intelephense").get("sail.path");
  const vendorSailPath = import_path5.default.join(import_coc11.workspace.root, "vendor", "bin", "sail");
  if (sailPath && import_fs4.default.existsSync(sailPath)) {
    cmdPath = sailPath;
  } else if (import_fs4.default.existsSync(vendorSailPath)) {
    cmdPath = import_path5.default.join(import_coc11.workspace.root, "vendor", "bin", "sail");
  }
  return cmdPath;
}
async function runPhpUnit(filePath, testName) {
  ...
  const sailBin = getSailPath2();
  const useSail = import_coc11.workspace.getConfiguration("intelephense").get("phpunit.useSail", false);
  if (phpunitBin) {
    if (terminal3) {
      if (terminal3.bufnr) {
    ...
    if (testName && filePath) {
      ...
      args.push(`'::${testName}$'`);
      if (useSail) {
        const relativeFilePath = filePath.replace(import_coc11.workspace.root, "").replace(/^\//, "");
        args.push(`${relativeFilePath}`);
        terminal3.sendText(`${sailBin} phpunit ${args.join(" ")}`);
      } else {
        args.push(`${filePath}`);
      ...
      if (useSail) {
        terminal3.sendText(`${sailBin} phpunit`);
      } else {
        args.push(`${filePath}`);
...
function phpunitSingleTestCommand() {
  return async () => {
    ...
    if (!ast)
      return;
    const testItems = getPhpUnitTestItems(ast);
    const testName = getPhpUnitTestNameAtEditorOffset(testItems, editorOffset);
    if (testName) {
...
var terminal4;
function register12(context) {
  import_coc12.listManager.registerList(new SymfonyList());
  import_coc12.listManager.registerList(new ArtisanList());
  import_coc12.listManager.registerList(new SailArtisanList());
  context.subscriptions.push(
    import_coc12.commands.registerCommand("intelephense.artisan.runCommand", () => {
      import_coc12.workspace.nvim.command(`CocList artisan`);
    })
  );
  context.subscriptions.push(
    import_coc12.commands.registerCommand("intelephense.sailArtisan.runCommand", () => {
      import_coc12.workspace.nvim.command(`CocList sail`);
    })
  );
  context.subscriptions.push(
    import_coc12.commands.registerCommand("intelephense.symfony.runCommand", () => {
...
async function getSymfonyConsolePath(entryPoint) {
  let cmdPath = "";
  if (entryPoint === "sail") {
    const sailPath = import_path6.default.join(import_coc12.workspace.root, "vendor", "bin", entryPoint);
    if (import_fs5.default.existsSync(sailPath)) {
      cmdPath = sailPath;
    }
  } else {
...
async function runSymfonyConsole(commandName, entryPoint, baseCommandName) {
  ...
  const artisanWithoutArgumentsCommandList = import_coc12.workspace.getConfiguration("intelephense").get("artisan.withoutArgumentsCommandList", []);
  const symfonyWithoutArgumentsCommandList = import_coc12.workspace.getConfiguration("intelephense").get("symfony.withoutArgumentsCommandList", []);
  const withoutArgumentsCommandList = [];
...
var SymfonyConsoleList = class extends import_coc12.BasicList {
  ...
  async loadItems(_context) {
    ...
    if (symfonyConsolePath.endsWith("sail"))
      symfonyConsolePath = symfonyConsolePath + " artisan";
    const commands10 = await getSymfonyConsoleListCommandsJson(symfonyConsolePath);
    commands10.forEach((c) => listItems.push({ label: c }));
    return listItems;
  }
};
...
var SailArtisanList = class extends SymfonyConsoleList {
  constructor() {
    super(...arguments);
    this.name = "sail";
    this.description = "sail artisan for coc-intelephense";
    this.entryPoint = "sail";
  }
};
...
function register13(context) {
  if (import_coc13.workspace.getConfiguration("intelephense").get("client.autoCloseDocCommentDoSuggest", true)) {
    import_coc13.workspace.onDidChangeTextDocument(
      (e) => {
        setTimeout(async () => {
          if (!supportFileExtensions.includes(import_path7.default.extname(e.textDocument.uri)))
            return;
          ...
          if (currentLine.endsWith("*/") || nextLine.endsWith("*/"))
            return;
          if (e.contentChanges[0].text === "*" && currentLine === "/*" || // In the case of fast input, the contentChanges text character is 2 characters.
          e.contentChanges[0].text === "**" && currentLine === "/") {
            ...
            await import_coc13.snippetManager.insertSnippet(
              "${0} */",
              true,
              import_coc13.Range.create(
                import_coc13.Position.create(
            ...
            import_coc13.workspace.nvim.call("coc#start");
          }
        }, 50);
      },
      null,
...
function register14(context) {
  if (!import_coc14.workspace.getConfiguration("intelephense").get("client.disableScaffoldCompletion", false)) {
    context.subscriptions.push(
      import_coc14.languages.registerCompletionItemProvider(
...
var ScaffoldCompletionProvider = class {
  async getScaffoldCompletions(document) {
    ...
    const composerJsonPath = import_path8.default.join(import_coc14.workspace.root, "composer.json");
    let composerJsonContent = null;
    try {
...
var SnippetsCompletionProvider = class {
  constructor(context) {
    ...
    this.snippetsFilePath = import_path9.default.join(this._context.extensionPath, "data", "snippets", "extended", "php.code-snippets");
...
var parserEngine6 = new import_php_parser7.Engine({
  parser: {
    extractDoc: true,
    php7: true,
    locations: true,
...
// src/inlayHints/inlineParameters.ts
async function register16(context, client) {
  if (!import_coc16.workspace.getConfiguration("intelephense").get("client.disableInlayHints", true)) {
    await client.onReady();
    const documentSelector = [{ language: "php", scheme: "file" }];
    const disposable = import_coc16.languages.registerInlayHintsProvider(
      documentSelector,
...
var InlineParametersInlayHintsProvider = class {
    ...
    for (const languageParameters of functionParmeters) {
      ...
      for (let index = 0; index < languageParameters.length; index++) {
        try {
          ...
          if (!parameterName)
            continue;
          const position = import_coc16.Position.create(parameter.start.line - 1, parameter.start.character);
  ...
  async getParameterNames(document, languageParameters) {
    ...
    let parameters = [];
    const position = import_coc16.Position.create(
...
function register17(context) {
  if (!import_coc17.workspace.getConfiguration("intelephense").get("client.disableCodeLens", false)) {
    ...
    if (useCodelensProvider === "pest") {
      context.subscriptions.push(
        import_coc17.languages.registerCodeLensProvider([{ language: "php", scheme: "file" }], new PestCodeLensProvider())
      );
    }
  }
}
var PestCodeLensProvider = class {
  ...
  async provideCodeLenses(document, _token) {
    ...
    try {
      ...
      if (phpUnitStyleTestItems.length > 0) {
        for (const t of phpUnitStyleTestItems) {
          ...
          const lens = {
            range: import_coc17.Range.create(startPostion, endPostion),
            command: {
              title: codeLensTitle,
    ...
    try {
      ...
      if (!ast)
        return;
      const pestTestItems = getPestTestItems(ast);
...
function register18(context) {
  if (!import_coc18.workspace.getConfiguration("intelephense").get("client.disableCodeLens", false)) {
    ...
    if (useCodelensProvider === "phpunit") {
      context.subscriptions.push(
        import_coc18.languages.registerCodeLensProvider([{ language: "php", scheme: "file" }], new PHPUnitCodeLensProvider())
      );
    }
  }
}
    ...
    try {
      ...
      if (testItems.length > 0) {
        for (const t of testItems) {
          ...
          const endPostion = document.positionAt(t.endOffset);
          const lens = {
            range: import_coc18.Range.create(startPostion, endPostion),
            command: {
              title: codeLensTitle,
...
var languageClient;
var inlineParametersInlayHintsDisposable;
async function activate(context) {
  ...
  context.subscriptions.push(
    import_coc19.commands.registerCommand(INDEX_WORKSPACE_CMD_NAME, indexWorkspace),
    import_coc19.commands.registerCommand(CANCEL_INDEXING_CMD_NAME, cancelIndexing)
  );
  clientDisposable = import_coc19.services.registLanguageClient(languageClient);
  register13(context);
  register14(context);
  register15(context);
  register7(context);
  ...
  register2(context);
  register5(context);
  if (inlineParametersInlayHintsDisposable)
    inlineParametersInlayHintsDisposable.dispose();
  inlineParametersInlayHintsDisposable = await register16(context, languageClient);
}
